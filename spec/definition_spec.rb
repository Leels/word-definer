...
describe '#Definition' do
  ...
  describe('#==') do
    it("is the same definition if it has the same attributes as another definition") do
      ...
      definition2 = Definition.new("blah blah", @word.id, nil)
  ...
  describe('.all') do
    it("returns a list of all definitions") do
      definition = Definition.new("blah blah", @word.id, nil)
      definition.save()
      definition2 = Definition.new("yada yada", @word.id, nil)
      definition2.save()
  ...
  describe('#update') do
    it("updates an definition by id") do
      definition = Definition.new("yada yada", @word.id, nil)
      definition.save()
      definition.update("bloop bleep", @word.id)
      expect(definition.definition_text).to(eq("bloop bleep"))
    end
  end
